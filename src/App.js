...
function App() {
  ...
  const renderQuizSection = () => {
    if (quizMode === "welcome") {
      return (
        <div className="welcome-screen">
          <h2>Welcome to GameX  Quiz</h2>
          <p>Test your knowledge with questions on GameX</p>
          ...
          <div className="quiz-options">
            <div className="questioncount">
              ...
              <div className="count-buttons">
                <button 
                  className={questionsCount === 3 ? "selected" : ""} 
            ...
            {/* <button className="start-button" onClick={() => { startQuiz(questionsCount);  
            window.location.href = "https://lalithsrini.github.io/kidlearn/games"; 
            }}> Game Quiz </button> */}
    ...
    if (quizMode === "results") {
      ...
      if (percentage >= 90) {
        feedback = "Outstanding! You're an expert in Onhealth Quiz!";
      } else if (percentage >= 70) {
        feedback = "Great job! You have a solid understanding of the subject.";
      } else if (percentage >= 50) {
        feedback = "Good effort! Keep learning to improve your knowledge.";
